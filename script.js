const samenvatting2 = document.querySelector(".samenvatting2");
const serieuzeTekst = `De Nederlandse economie groeit gematigd door in 2026 en 2027, gedragen
